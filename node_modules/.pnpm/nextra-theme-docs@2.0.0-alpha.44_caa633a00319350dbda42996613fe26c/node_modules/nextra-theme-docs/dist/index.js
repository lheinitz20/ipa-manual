...
// src/index.tsx
import React25, { useMemo as useMemo3, useState as useState7 } from "react";
...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ React8.createElement("div", {
    className: "nextra-nav-container z-20 sticky top-0 bg-transparent w-full"
  ...
  }, render_component_default(config.logo, { locale })))), items ? items.map((page) => {
    if (page.hidden)
      return null;
    ...
    return /* @__PURE__ */ React8.createElement(Link3, {
      ...
      className: cn3("no-underline whitespace-nowrap mr-4 hidden md:inline-block", isActive ? "text-current" : "text-gray-500"),
...
function Menu({ options, selected, onChange }) {
  return /* @__PURE__ */ React11.createElement(Listbox, {
    ...
    className: cn4("rounded-md px-2 w-full text-left font-medium cursor-default text-xs h-7 transition-colors text-gray-600 dark:text-gray-400 focus:outline-none", open ? "bg-gray-200 dark:bg-prime-100 dark:bg-opacity-10 text-gray-900 dark:text-gray-50" : "hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-prime-100 dark:hover:bg-opacity-5 dark:hover:text-gray-50")
    ...
    key: option.key,
    value: option,
    className: ({ active }) => cn4(option.key === selected.key ? "" : "", active ? "text-prime-500 bg-prime-50 dark:bg-prime-500 dark:bg-opacity-10" : "text-gray-800 dark:text-gray-100", "cursor-default select-none relative py-1.5 pl-3 pr-9 whitespace-nowrap")
...
var NextLink = ({ route, title, isRTL }) => {
  return /* @__PURE__ */ React17.createElement(Link4, {
    ...
    className: cn5("text-lg font-medium p-4 -m-4 no-underline transition-colors text-gray-600 dark:text-gray-300 dark:hover:text-prime-500 hover:text-prime-500 inline-flex items-center", { "ml-2": !isRTL, "mr-2": isRTL }),
    title
...
var PrevLink = ({ route, title, isRTL }) => {
  return /* @__PURE__ */ React17.createElement(Link4, {
    ...
    className: cn5("text-lg font-medium p-4 -m-4 no-underline transition-colors text-gray-600 dark:text-gray-300 dark:hover:text-prime-500 hover:text-prime-500 flex items-center", { "mr-2": !isRTL, "ml-2": isRTL }),
    title
...
var NavLinks = ({
  ...
  return /* @__PURE__ */ React17.createElement("div", {
    className: "pt-8 mt-16 mb-8 border-t dark:border-neutral-800 flex flex-row items-center justify-between"
  }, /* @__PURE__ */ React17.createElement("div", {
    className: "flex-1 min-w-0"
  }, prev && config.prevLinks ? /* @__PURE__ */ React17.createElement(PrevLink, {
    route: prev.route,
    title: prev.title,
    isRTL
  }) : null), /* @__PURE__ */ React17.createElement("div", {
    className: "flex-1 min-w-0 text-right"
  }, config.nextLinks && next ? /* @__PURE__ */ React17.createElement(NextLink, {
    route: next.route,
    title: next.title,
    isRTL
  }) : null));
...
var Footer = ({ menu }) => {
  ...
  return /* @__PURE__ */ React17.createElement("footer", {
    ...
    className: cn5("py-2 border-b dark:border-neutral-800", menu ? "" : "md:hidden")
  }, /* @__PURE__ */ React17.createElement("div", {
...
var HeaderLink = (_a) => {
  ...
  const slug = id;
  const anchor = /* @__PURE__ */ React20.createElement("span", {
  ...
  return /* @__PURE__ */ React20.createElement(Tag, __spreadValues({}, props), anchor, /* @__PURE__ */ React20.createElement("a", {
    href: "#" + slug,
    className: "text-current no-underline no-outline"
  }, children, /* @__PURE__ */ React20.createElement("span", {
...
var H2 = (context) => (_a) => {
  ...
  return /* @__PURE__ */ React20.createElement(HeaderLink, __spreadValues({
    tag: "h2",
    context
  }, props), children);
};
...
var A = (_a) => {
  ...
  if (isExternal) {
    return /* @__PURE__ */ React20.createElement("a", __spreadValues({
      target: "_blank",
      rel: "noreferrer"
    }, props), children);
  }
  return props.href ? /* @__PURE__ */ React20.createElement(Link5, {
    href: props.href
  }, /* @__PURE__ */ React20.createElement("a", __spreadValues({}, props), children)) : /* @__PURE__ */ React20.createElement(React20.Fragment, null);
};
var Table = ({ children }) => {
  return /* @__PURE__ */ React20.createElement("div", {
    className: "table-container"
  }, /* @__PURE__ */ React20.createElement("table", null, children));
};
var DetailsContext = React20.createContext(() => {
});
var findSummary = (children) => {
  ...
  React20.Children.forEach(children, (child) => {
    if (child && child.type === Summary) {
      ...
      let c = child;
      if (typeof child === "object" && child && child.type !== Details && "props" in child && child.props) {
        const result = findSummary(child.props.children);
        summary = summary || result[0];
        c = React20.cloneElement(child, __spreadProps(__spreadValues({}, child.props), { children: result[1] }));
      }
      restChildren.push(c);
    }
  });
...
var Details = (_a) => {
  ...
  return /* @__PURE__ */ React20.createElement("details", __spreadValues(__spreadProps(__spreadValues({}, props), {
    ref,
    open: true
  }), openState ? { "data-open": "" } : null), /* @__PURE__ */ React20.createElement(DetailsContext.Provider, {
    value: setOpen
  }, summary), /* @__PURE__ */ React20.createElement(Collapse, {
    open: openState
  }, restChildren));
};
var Summary = (_a) => {
  ...
  return /* @__PURE__ */ React20.createElement("summary", __spreadProps(__spreadValues({}, props), {
    onClick: (e) => {
      e.preventDefault();
      setOpen((v) => !v);
    }
...
var MDXTheme = ({ children }) => {
  return /* @__PURE__ */ React20.createElement(MDXProvider, {
    components: getComponents({ index: 0 })
  }, children);
};

// src/sidebar.tsx
import React21, { useState as useState5, useEffect as useEffect5, useMemo as useMemo2 } from "react";
...
// src/sidebar.tsx
var TreeState = {};
var Folder = React21.memo(FolderImpl);
function FolderImpl({ item, anchors }) {
  ...
  const link = /* @__PURE__ */ React21.createElement("a", {
    ...
    childProps: {
      className: cn6("transition-transform origin-center", open ? "rotate-90" : "")
    }
  })));
  return /* @__PURE__ */ React21.createElement("li", {
    className: cn6({ open, active })
  }, item.withIndexPage ? /* @__PURE__ */ React21.createElement(Link6, {
    href: item.route
  }, link) : link, /* @__PURE__ */ React21.createElement(Collapse, {
    open
...
function File({ item, anchors }) {
  ...
  if (anchors && anchors.length) {
    if (active) {
      ...
      }, /* @__PURE__ */ React21.createElement("a", __spreadProps(__spreadValues({}, item.newWindow ? { target: "_blank", rel: "noopener noreferrer" } : {}), {
        onClick: () => {
          setMenu(false);
        }
      }), title)), /* @__PURE__ */ React21.createElement("ul", null, anchors.map((_, i) => {
...
function Sidebar({
  ...
  return /* @__PURE__ */ React21.createElement("aside", {
    className: cn6("nextra-sidebar-container fixed flex-shrink-0 w-full md:w-64 md:sticky z-[15] top-16 self-start overflow-y-auto transform-none h-[calc(100vh-4rem)]", asPopover ? "md:hidden" : "md:block", { open: menu })
  ...
  }, config.customSearch || (config.search ? config.unstable_flexsearch ? /* @__PURE__ */ React21.createElement(Search2, null) : /* @__PURE__ */ React21.createElement(search_default, {
    directories: flatDirectories
    ...
    options: config.i18n
  })) : null, config.darkMode ? /* @__PURE__ */ React21.createElement(React21.Fragment, null, /* @__PURE__ */ React21.createElement("div", {
    className: cn6("relative md:hidden", {
      locale: config.i18n,
      "flex-1": !config.i18n
    })
  }, /* @__PURE__ */ React21.createElement(theme_switch_default, {
    lite: false
  })), /* @__PURE__ */ React21.createElement("div", {
...
function ToC({
  ...
  return /* @__PURE__ */ React22.createElement("div", {
    ...
    className: "overflow-y-auto sticky max-h-[calc(100vh-4rem-env(safe-area-inset-bottom))] top-16 pt-8"
  }, hasHeadings && headings ? /* @__PURE__ */ React22.createElement("ul", null, /* @__PURE__ */ React22.createElement("p", {
    className: "font-semibold tracking-tight mb-4"
  }, "Auf dieser Seite"), headings.map((heading) => {
    ...
    return /* @__PURE__ */ React22.createElement("li", {
      ...
      href: `#${slug}`,
      className: cn7("no-underline inline-block", heading.depth === 2 ? "font-semibold" : "", (state == null ? void 0 : state.isActive) ? "text-prime-500 subpixel-antialiased" : "text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300"),
      "aria-selected": state == null ? void 0 : state.isActive
    }, text));
  })) : null, hasMetaInfo ? /* @__PURE__ */ React22.createElement("div", {
    className: cn7(hasHeadings ? "border-t mt-8 pt-8 shadow-[0_-12px_16px_white] dark:shadow-[0_-12px_16px_#111] bg-white dark:bg-dark" : "", "sticky pb-8 bottom-0 dark:border-neutral-800")
  }, config.feedbackLink ? /* @__PURE__ */ React22.createElement(FeedbackLink, {
...
var defaultTheme = {
  ...
  logo: /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement("span", {
    className: "mr-2 font-extrabold hidden md:inline"
  }, "Nextra"), /* @__PURE__ */ React23.createElement("span", {
    className: "text-gray-600 font-normal hidden md:inline"
  }, "The Next Docs Builder")),
  head: /* @__PURE__ */ React23.createElement(React23.Fragment, null, /* @__PURE__ */ React23.createElement("meta", {
    name: "msapplication-TileColor",
    content: "#ffffff"
  }), /* @__PURE__ */ React23.createElement("meta", {
  ...
  unstable_searchResultEmpty: () => /* @__PURE__ */ React23.createElement("span", {
...
function Breadcrumb({ activePath }) {
  return /* @__PURE__ */ React24.createElement("div", {
    className: "text-sm font-normal flex mt-2.5 text-gray-500 transition-colors cursor-default overflow-hidden"
  }, activePath.map((item, index) => {
    const isLink = !item.children || item.withIndexPage;
    const isActive = index === activePath.length - 1;
    return /* @__PURE__ */ React24.createElement(React24.Fragment, {
      key: item.route
    }, index ? /* @__PURE__ */ React24.createElement("span", {
      className: "mx-2 select-none"
    }, "/") : null, /* @__PURE__ */ React24.createElement("div", {
      key: item.route,
      className: cn8("transition-colors hover:text-gray-900 dark:hover:text-gray-200", {
        "text-gray-600 dark:text-gray-400": isActive,
        "text-ellipsis whitespace-nowrap overflow-hidden min-w-[24px]": !isActive
      })
    }, isLink && !isActive ? /* @__PURE__ */ React24.createElement(Link7, {
      href: item.route
...
var Body = ({
  ...
  return /* @__PURE__ */ React25.createElement(React25.Fragment, null, /* @__PURE__ */ React25.createElement(SkipNavContent, null), themeContext.full ? /* @__PURE__ */ React25.createElement("article", {
    className: cn9("nextra-body full relative overflow-x-hidden", !themeContext.sidebar ? "expand" : "")
  }, /* @__PURE__ */ React25.createElement(MDXTheme, null, children)) : /* @__PURE__ */ React25.createElement("article", {
    className: "nextra-body relative pb-8 w-full max-w-full flex min-w-0 pr-[calc(env(safe-area-inset-right)-1.5rem)]"
  }, /* @__PURE__ */ React25.createElement("main", {
    className: "mx-auto max-w-4xl px-6 md:px-8 pt-4 z-10 min-w-0 w-full"
  }, breadcrumb, /* @__PURE__ */ React25.createElement(MDXTheme, null, children), navLinks), toc));
};
var Content = ({
  filename,
  pageMap,
  ...
  return /* @__PURE__ */ React25.createElement(React25.Fragment, null, /* @__PURE__ */ React25.createElement(Head, {
    title,
    locale,
    meta
  }), /* @__PURE__ */ React25.createElement(MenuContext.Provider, {
    value: {
      menu,
      setMenu,
  ...
  }, themeContext.navbar ? /* @__PURE__ */ React25.createElement(Navbar, {
    isRTL,
    flatDirectories,
    items: topLevelPageItems
  }) : null, /* @__PURE__ */ React25.createElement(ActiveAnchor, null, /* @__PURE__ */ React25.createElement("div", {
    className: "max-w-[90rem] w-full mx-auto"
  }, /* @__PURE__ */ React25.createElement("div", {
    className: "flex flex-1 h-full"
  }, /* @__PURE__ */ React25.createElement(Sidebar, {
  ...
  }), /* @__PURE__ */ React25.createElement(Body, {
    themeContext,
    breadcrumb: activeType === "page" ? null : themeContext.breadcrumb ? /* @__PURE__ */ React25.createElement(Breadcrumb, {
      activePath
    }) : null,
    toc: activeType === "page" ? null : themeContext.toc ? /* @__PURE__ */ React25.createElement(ToC, {
      headings: config.floatTOC ? headings : null,
      filepathWithName
    }) : null,
    navLinks: activeType === "page" ? null : themeContext.pagination ? /* @__PURE__ */ React25.createElement(NavLinks, {
      flatDirectories: flatDocsDirectories,
      currentIndex: activeIndex,
      isRTL
    }) : null
  }, children)))), themeContext.footer && config.footer ? /* @__PURE__ */ React25.createElement(footer_default, {
    menu: activeType === "page" || !themeContext.sidebar
  }) : null)));
};
var GlobalLayout;
var src_default = (opts, _config) => {
  ...
  if (!GlobalLayout) {
    GlobalLayout = function({
      ...
      return /* @__PURE__ */ React25.createElement(ThemeConfigContext.Provider, {
        value: config
      }, /* @__PURE__ */ React25.createElement(ThemeProvider, __spreadValues({
        attribute: "class",
      ...
      }), /* @__PURE__ */ React25.createElement(Content, __spreadValues({}, opts2), children)));
    };
  }
  ...
  Page.withLayout = (page) => {
    return /* @__PURE__ */ React25.createElement(GlobalLayout, {
      opts,
